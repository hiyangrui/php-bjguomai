<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"E:\Code\blog\public/../application/admin\view\article\add.html";i:1531792624;s:54:"E:\Code\blog\application\admin\view\common\header.html";i:1535716696;s:52:"E:\Code\blog\application\admin\view\common\menu.html";i:1530534551;s:54:"E:\Code\blog\application\admin\view\common\footer.html";i:1529459493;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="title" placeholder="" name="title" type="text" required="" maxlength="60">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="author" placeholder="" name="author" type="text" maxlength="30">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="keywords" placeholder="" name="keywords" type="text" required="" maxlength="100">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control" style="resize: none" id="desc" placeholder="" name="desc" type="text" required="" maxlength="255"></textarea>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="control-group">
                                            <div class="radio" style="float: left;margin-right: 10px"><label><input  name="recommend" value="1" type="radio"><span class="text">是</span></label></div>
                                            <div class="radio" style="float: left;margin-right: 10px"><label><input name="recommend" checked="checked" type="radio" value="0"><span class="text">否</span></label></div>
                                        </div>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="control-group">
                                            <div class="radio" style="float: left;margin-right: 10px"><label><input checked="checked" name="status" value="1" type="radio"><span class="text">是</span></label></div>
                                            <div class="radio" style="float: left;margin-right: 10px"><label><input name="status" type="radio" value="0"><span class="text">否</span></label></div>
                                        </div>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" id="cateid" placeholder="" name="cateid" type="file" required="">
                                            ...
                                            <option value="<?php echo $cate['id']; ?>"><?php if($cate['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('---', $cate['level']) ?><?php echo $cate['catename']; ?></option>
                                ...
                                <!--<div class="form-group">-->
                                    <!--<label for="isrecommend" class="col-sm-2 control-label no-padding-right">是否推荐</label>-->
                                    <!--<div class="col-sm-6">-->
                                        <!--<label>-->
                                            <!--<input class="checkbox-slider yesno" type="checkbox" checked id="isrecommend" name="isrecommend">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea style="resize: none;height: 100px" id="content" placeholder="" name="content" type="text"></textarea>
                                    </div>
